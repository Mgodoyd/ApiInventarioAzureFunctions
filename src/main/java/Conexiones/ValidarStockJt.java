...
public class ValidarStockJt {
    public boolean ChangeProductById(int id, int cantidad) throws SQLException {
        ...
        try ( Connection connection = DB1Config.getconnection1()) {
            ...
            PreparedStatement statement2 = connection.prepareStatement(selectSql);
            statement2.setInt(1, id);
            resultSet = statement2.executeQuery();

            if (resultSet.next()) {
                System.out.println("Producto encontrado en la db: " + connection);
